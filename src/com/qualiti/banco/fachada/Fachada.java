...
public class Fachada implements IFachada {
	...
	private static IFachada fachadaInstanciada;//caso varios objetos o queiram. sem precisar criar outro objeto
	...
	public static IFachada getFachada(){
		...
		return fachadaInstanciada; //se for nulo, retornara a fachadaInstanciada que ja existe.
	...
	public double somarSaldo(TipoConta tipo) {
		...
		return negocioContas.somarSaldo(tipo);
	}
